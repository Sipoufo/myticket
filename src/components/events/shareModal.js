...
import { FaFacebook, FaTwitter, FaWhatsapp } from 'react-icons/fa'; // Facultatif : utilisez des icônes pour les boutons
...
const ShareModal = (
    ...
    return (
    //   <div className='z-999 fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity'>
    ...
    //   </div>
    <div>
      <FacebookShareButton url={shareUrl} quote={title} className='border hover:bg-[#1877f2] w-12 h-12 fill-[#1877f2] border-blue-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-blue-500/50 cursor-pointer'>
      ...
      <TwitterShareButton url={shareUrl} hashtags={["Gaming"]} title={title} class="border hover:bg-[#1d9bf0] w-12 h-12 fill-[#1d9bf0] border-blue-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-sky-500/50 cursor-pointer">
